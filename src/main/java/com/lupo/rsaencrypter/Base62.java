...
//THX FOR THE CODE ARTOB :D :D :D :D I really dont want to have to write an encoder myself.
...
public class Base62 {
  ...
  public static String encodeInt(BigInteger number) {
   ...
   */
  public static BigInteger decodeInt(final String string) {
    if (string.length() == 0) {
